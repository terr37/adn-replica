      ...
      <div className="relative z-20 max-w-7xl mx-auto w-full px-6 sm:px-8 lg:px-16 flex items-center h-full">
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-gray-300 text-base md:text-lg mb-10 max-w-md leading-relaxed">
            Su canal de conexión con el Distrito Nacional. Reporte incidencias en la vía pública de forma inmediata o gestione sus trámites desde una plataforma ágil y moderna.
          </p>

          {/* Acciones principales */}
          <div className="flex flex-col sm:flex-row gap-4">

            {/* Botón Principal: "Reportar Incidencia" con Ancla al Mapa */}
            <Link
              href="#mapa-incidencias"
              className="group bg-[#B8902F] hover:bg-[#CBA23E] text-[#051429] px-8 py-4 rounded-lg font-bold flex items-center justify-center gap-2.5 active:scale-[0.98] shadow-lg shadow-[#B8902F]/20 transition-all duration-300 ease-out hover:shadow-[0_0_30px_rgba(184,144,47,0.55)]"
            >
            ...
            <Link
              href="/servicios"
              className="group bg-white/5 hover:bg-white/10 border border-white/15 text-white px-8 py-4 rounded-lg font-semibold transition-all active:scale-[0.98] backdrop-blur-sm flex items-center justify-center gap-2 hover:border-white/30"
            >
              Explorar Servicios
